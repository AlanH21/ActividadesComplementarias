	...
	$show_form = FALSE;
		...
		if($_POST) {
				...
				$rfc = isset($_POST['trabajador_rfc']) ? $_POST['trabajador_rfc']: '';
			  	...
			  	header('Location: Departamento_B_E_E.php');
		    }

			if(isset( $_GET['rfc_departamento'] )) {
...
<div class="container">
	<div class="col s12">
		...
		<form method="post">
			...
			<input class="btn waves-effect waves-light" type="submit" value = "Cancelar" onClick ="Departamento_B_E_E.php">
		</form>
		</div>
	</div>
</div>
			...
			<thead>
				...
				<tbody>
					...
					<tr>
						...
						<td class="center">
							<a class="btn waves-effect waves-light cyan lighten-1" href="Departamento_B_E_E.php?rfc_departamento=<?php echo $rs['rfc_departamento']; ?>">Editar</a>
						</td>

						<td  class="center">
							<a class="btn waves-effect waves-light red" onclick="Eliminar_Departamento('<?php echo $rs["rfc_departamento"]; ?>')" href="#">ELIMINAR</a>
					 	</td>
					 </tr>
					<?php
					   	}
