...
<?php
	...
	//modificar--------------------------------------->
		...
		$rfc = isset($_POST['act_complementaria_clave_act']) ? $_POST['act_complementaria_clave_act']: '';
			  	...
			  	header('Location: Instructor_B_E_E.php');
		    }
...
<div class="container">
	<div class="col s12">
		<form method="get">
      			<h2 class="card-title">Buscar Instructor</h2>
...
<div class="container col s12 row">
	<div class="card">
		...
		<form method="post">
			...
			<input class="btn waves-effect waves-light" type="submit" value = "Cancelar" onClick ="Instructor_B_E_E.php">
			...
			<thead>
				...
				<tbody>
					...
					<tr>
						...
						<td class="center">
							<a class="btn waves-effect waves-light cyan lighten-1" href="Instructor_B_E_E.php?rfc_instructor=<?php echo $rs['rfc_instructor']; ?>">Editar</a>
						</td>

						<td  class="center">
							<a class="btn waves-effect waves-light red" onclick="Eliminar_Instructor('<?php echo $rs["rfc_instructor"]; ?>')" href="#">ELIMINAR</a>
					 	</td>
					 </tr>
					<?php
					   	}
