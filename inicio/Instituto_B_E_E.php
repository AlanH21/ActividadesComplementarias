	...
	$show_form = FALSE;
		...
		if($_POST) {
				...
				$nombreactividad= isset($_POST['nombre_instituto']) ? $_POST['nombre_instituto']: '';
			  	...
			  	header('Location: Instituto_B_E_E.php');
		    }
...
<div class="container col s12 row">
	<div class="col s12">
		...
		<form method="post">
			...
			<input class="btn waves-effect waves-light" type="submit" value = "Cancelar" onClick ="Instituto_B_E_E.php">
			...
			<thead>
				...
				<tbody>
					...
					<tr>
						...
						<td class="center">
							<a class="btn waves-effect waves-light cyan lighten-1" href="Instituto_B_E_E.php?clave_instituto=<?php echo $rs['clave_instituto']; ?>">Editar</a>
						</td>

						<td  class="center">
							<a class="btn waves-effect waves-light red" onclick="Eliminar_Instituto('<?php echo $rs["clave_instituto"]; ?>')" href="#">ELIMINAR</a>
					 	</td>
					 </tr>
					<?php
					   	}
