<?php
	...
	if ($_POST) {
			...
			$noControl_2 = isset($_POST['No_control_2']) ? $_POST['No_control_2']: '';
		  	...
		  	header('Location: Alumnos_B_E_E.php');
	}
	...
	$sql_status = 'SELECT estudiante.*, carrera.nombre_carrera from estudiante INNER JOIN carrera on carrera.clave_carrera = estudiante.carrera_clave WHERE nombre_estudiante LIKE :search ORDER BY apellido_p_estudiante asc';
	...
	<div class="card">
		...
		<form method="post">
        	...
        	<input class="btn waves-effect waves-light" type="submit" value="Modificar" />
					<input class="btn waves-effect waves-light" type="submit" value = "Cancelar" onClick ="Alumnos_B_E_E.php">
		</form>
		 <?php
		 	}
		  ?>
...
<div class="container" >
	<div class="col s12">
		<div class="row">
			<a class="btn waves-effect waves-light cyan right" href="Alumnos_A.php">Mostrar todo</a>
			<h3>Estudiantes</h3>
			<table class="striped">
				...
				?>
					<tr>
						...
						<td><a class="btn waves-effect waves-light cyan lighten-1" href="Alumnos_B_E_E.php?No_control=<?php echo $rs2['No_control']; ?>">Editar</a></td>

						<td><a class="btn waves-effect waves-light red" onclick="Eliminar_Alumnos('<?php echo $rs2["No_control"]; ?>')" href="#">ELIMINAR</a>
					</tr>
