...
<div class="container">
	<div class="col s12">
		...
		<form method="post">
			...
			<input class="btn waves-effect waves-light" type="submit" value = "Cancelar" onClick ="Solicitud_B_E_E.php">
		</form>
		</div>
	</div>
</div>
    ...
    <table class="responsive-table">
        ...
        <tbody>
            ...
            <tr>
				...
				<td class="center">
					<a class="btn waves-effect waves-light cyan lighten-1" href="Solicitud_B_E_E.php?folio=<?php echo $rs['folio']; ?>">Editar</a>
				</td>

				<td  class="center">
					<a class="btn waves-effect waves-light red" onclick="Eliminar_Solicitud('<?php echo $rs["folio"]; ?>')" href="#">ELIMINAR</a>
				</td>
