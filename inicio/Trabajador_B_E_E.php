...
<?php
	...
	$show_form = FALSE;
		...
		$apellido_m = isset($_POST['apellido_m']) ? $_POST['apellido_m']: '';
			  	...
			  	header('Location: Trabajador_B_E_E.php');
		    }
...
<div class="container col s12 row">
	<div class="card">
		...
		<form method="post">
			...
			<input class="btn waves-effect waves-light" type="submit" value = "Cancelar" onClick ="Trabajador_B_E_E.php">
		</form>
		</div>
	</div>
</div>
			...
			<thead>
				...
				<tbody>
					...
					<tr>
						...
						<td class="center">
							<a class="btn waves-effect waves-light cyan lighten-1" href="Trabajador_B_E_E.php?rfc_trabajador=<?php echo $rs['rfc_trabajador']; ?>">Editar</a>
						</td>

						<td  class="center">
							<a class="btn waves-effect waves-light red" onclick="Eliminar_Trabajador('<?php echo $rs["rfc_trabajador"]; ?>')" href="#">ELIMINAR</a>
					 	</td>
					 </tr>
					<?php
					   	}
