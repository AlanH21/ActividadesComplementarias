...
if($_POST) {
	...
	$nombreactividad= isset($_POST['nombre_complementarias']) ? $_POST['nombre_complementarias']: '';
  	...
  	header('Location: Actividades_B_E_E.php');
}
...
<h3>Modificar Actividad</h3>
		<form method="post">
			...
			<input class="btn waves-effect waves-light" type="submit" value = "Cancelar" onClick =" Actividades_B_E_E.php">
		</form>
		</div>
	</div>
</div>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="center">
								<a class="btn waves-effect waves-light cyan lighten-1" href="Actividades_B_E_E.php?clave_act=<?php echo $rs2['clave_act']; ?>">Editar</a>
							</td>

							<td class="center">
								<a class="btn waves-effect waves-light red" onclick="Eliminar_Actividad(<?php echo $rs2['clave_act']; ?>)" href="#">ELIMINAR</a>
							</td>
						</tr>
					<?php
						}
